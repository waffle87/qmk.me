...
#define ___LAYER12___ KC_VOLU, TD(PLY_NXT_PRV), _______, S(A(KC_TAB)), A(KC_TAB), _______, _______, _______, _______, _______
...
#define ___LAYER21___ KC_EXLM, KC_ASTR, PM_ASGN, KC_EQL, KC_AMPR, KC_HASH, HRMR(KC_LPRN, KC_RPRN, KC_QUOT, KC_DQUO)
