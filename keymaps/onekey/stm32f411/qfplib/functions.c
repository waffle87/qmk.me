...
//  We count the number of times each function was called. So we can check
//  whether our unit tests cover all functions.
...
uint8_t *get_float_usage(uint16_t *size) {
  *size = (uint16_t)LAST_FLOAT_USAGE_INDEX - 1;
  return float_usage;
}

//  Run-time ABI for the ARM Architecture.  The function names are wrapped via
//  "-Wl,-wrap,__aeabi..." in newlib/CMakeLists.txt.  See
...
int __wrap___aeabi_d2iz(double x) {
  ...
  //  qfp_float2int() works like floor().  If x is negative, we add 1 to the
  //  result.
...
// CMakeFiles/STM32_BLUE_PILL.dir/pxtapp/base/core.cpp.o: In function
// `Math_::sqrt(pxt::TValueStruct*)': /src/pxtapp/base/core.cpp:925: undefined
// reference to `sqrt'
...
// CMakeFiles/STM32_BLUE_PILL.dir/pxtapp/base/core.cpp.o: In function
// `Math_::log(pxt::TValueStruct*)': /src/pxtapp/base/core.cpp:901: undefined
// reference to `log'
...
// CMakeFiles/STM32_BLUE_PILL.dir/pxtapp/base/core.cpp.o: In function
// `Math_::log10(pxt::TValueStruct*)': /src/pxtapp/base/core.cpp:904: undefined
// reference to `log10'
...
double pow(double b, double x) {
  ...
  if (qfp_fcmp(b, 0) < 0 && qfp_fcmp(x, 0) < 0) {
    int xfloored = qfp_float2int(-x);
    if (xfloored % 2 == 1) {
      return -qfp_fexp(qfp_fmul(qfp_fln(-b), x));
    }
  }
  return qfp_fexp(qfp_fmul(qfp_fln(b), x));
}
...
double ldexp(double x, int ex) {
  ...
  return qfp_fmul(x, qfp_fexp(qfp_fmul(_M_LN2, ex)));
}
// Unit Tests:
// ldexp(7, -4) = 0.437500
// ldexp(-0, 10) = -0.000000
...
// CMakeFiles/STM32_BLUE_PILL.dir/pxtapp/base/core.cpp.o: In function
// `Math_::sin(pxt::TValueStruct*)': /src/pxtapp/base/core.cpp:910: undefined
// reference to `sin'
...
// CMakeFiles/STM32_BLUE_PILL.dir/pxtapp/base/core.cpp.o: In function
// `Math_::cos(pxt::TValueStruct*)': /src/pxtapp/base/core.cpp:913: undefined
// reference to `cos'

double cos(double x) {
  float_usage[USAGE_COS]++;
  //  If x is Pi/2, return 0.
  if (qfp_fcmp(x, M_PI_2) == 0) {
    return 0;
  }
  return qfp_fcos(x);
}
...
// CMakeFiles/STM32_BLUE_PILL.dir/pxtapp/base/core.cpp.o: In function
// `Math_::tan(pxt::TValueStruct*)': /src/pxtapp/base/core.cpp:907: undefined
// reference to `tan'
...
// CMakeFiles/STM32_BLUE_PILL.dir/pxtapp/base/core.cpp.o: In function
// `Math_::atan(pxt::TValueStruct*)': /src/pxtapp/base/core.cpp:916: undefined
// reference to `atan'

double atan2(double y, double x) {
  float_usage[USAGE_ATAN2]++;
  //  If x and y are both 0, return 0.
  if (qfp_fcmp(y, 0) == 0 && qfp_fcmp(x, 0) == 0) {
    return 0;
  }
...
double atan(double y_over_x) {
  ...
  if (qfp_fcmp(y_over_x, 0) == 0) {
    return y_over_x;
  }

  //  If the argument is +∞, +π/2 is returned
  if (isinf(y_over_x) && qfp_fcmp(y_over_x, 0) > 0) {
    return M_PI_2;
  }
...
// CMakeFiles/STM32_BLUE_PILL.dir/pxtapp/base/core.cpp.o: In function
// `Math_::asin(pxt::TValueStruct*)': /src/pxtapp/base/core.cpp:919: undefined
// reference to `asin'
...
double asin(double x) {
  ...
  //  Must call atan2 instead of qfp_fatan2 in case the values are 0.
  return atan2(x, qfp_fsqrt_fast(qfp_fsub(1, qfp_fmul(x, x))));
}
// Unit Tests:
// asin( 1.0) = +1.570796
// asin(-0.5) = -0.523599
...
// CMakeFiles/STM32_BLUE_PILL.dir/pxtapp/base/core.cpp.o: In function
// `Math_::acos(pxt::TValueStruct*)': /src/pxtapp/base/core.cpp:922: undefined
// reference to `acos'
...
double acos(double x) {
  ...
  //  Must call atan2 instead of qfp_fatan2 in case the values are 0.
  return qfp_fmul(2.0f, atan2(qfp_fsqrt_fast(qfp_fsub(1.0f, qfp_fmul(x, x))),
                              qfp_fadd(1.0f, x)));
}
// Unit Tests:
// acos(-1) = 3.141593
...
double sinh(double x) {
  ...
  return qfp_fmul(0.5f, qfp_fsub(qfp_fexp(x), qfp_fexp(-x)));
}
// Unit Tests:
// sinh(1) = 1.175201
// sinh(-1)=-1.175201
...
double cosh(double x) {
  ...
  return qfp_fmul(0.5f, qfp_fadd(qfp_fexp(x), qfp_fexp(-x)));
}
// Unit Tests:
// cosh(1) = 1.543081
// cosh(-1)= 1.543081
...
double tanh(double x) {
  ...
  float e2x = qfp_fexp( //  e^{2x}
      qfp_fmul(2.0f, x));
  return qfp_fdiv_fast(qfp_fsub(e2x, 1.0f), qfp_fadd(e2x, 1.0f));
}
// Unit Tests:
// tanh(1) = 0.761594
// tanh(-1) = -0.761594
...
double asinh(double x) {
  ...
  return qfp_fln(qfp_fadd(x,
                          qfp_fsqrt_fast( //  sqrt{ x^2 + 1 }
                              qfp_fadd(qfp_fmul(x, x), 1.0f))));
}
// Unit Tests:
// asinh(1) = 0.881374
// asinh(-1) = -0.881374
...
double atanh(double x) {
  ...
  return qfp_fmul(0.5f,
                  qfp_fln( //  ln ( {1+x} / {1-x} )
                      qfp_fdiv_fast(qfp_fadd(1.0f, x), qfp_fsub(1.0f, x))));
}
// Unit Tests:
// atanh(0) = 0.000000
// atanh(-0) = -0.000000
...
// CMakeFiles/STM32_BLUE_PILL.dir/pxtapp/base/core.cpp.o: In function
// `Math_::trunc(pxt::TValueStruct*)': /src/pxtapp/base/core.cpp:934: undefined
// reference to `trunc'
...
// CMakeFiles/STM32_BLUE_PILL.dir/pxtapp/base/core.cpp.o: In function
// `Math_::floor(pxt::TValueStruct*)': /src/pxtapp/base/core.cpp:928: undefined
// reference to `floor'
...
// CMakeFiles/STM32_BLUE_PILL.dir/pxtapp/base/core.cpp.o: In function
// `Math_::ceil(pxt::TValueStruct*)': /src/pxtapp/base/core.cpp:931: undefined
// reference to `ceil'
...
double fmod(double x, double y) {
  ...
  if (qfp_fcmp(x, 0) == 0 && qfp_fcmp(y, 0) != 0) {
    return 0;
  }
  ...
  if (qfp_fcmp(result, 0) < 0) {
    result = qfp_fadd(result, yabs);
  }

  // Composes a floating point value with the magnitude of result and the sign
  // of x. Was: return copysign(result, x);
...
double fabs(double x) {
  ...
  if (isnan(x) || isinf(x) || qfp_fcmp(x, 0) == 0) {
    return x;
  }
  if (qfp_fcmp(x, 0) < 0) {
    return -x;
