...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_waffle(
    ...
    KC_NO,      KC_Z, KC_X, KC_C, KC_V,  KC_B, RWORD,  KC_NO,      KC_NO, NUKE,    KC_N,      KC_M,  KC_COMM, KC_DOT, KC_SLSH,  KC_NO,
                      KC_NO,  UPDIR,  ESCLWR,  KC_SPC, KC_NO,      KC_NO, KC_BSPC, PSTRSE, PNP, KC_NO
  ),
